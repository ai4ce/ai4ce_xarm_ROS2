...
def launch_setup(context, *args, **kwargs):
    ...
    planning_pipeline_config['pilz_industrial_motion_planner'] = {}
    planning_pipeline_config['pilz_industrial_motion_planner'].update(pilz_planning_yaml)
    planning_pipeline_config['robot_description_planning'] = {}
    planning_pipeline_config['robot_description_planning'].update(pilz_limit_yaml)
